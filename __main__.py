...
import sys
import traceback
import IronRobot.modules.sql.users_sql as sql
from sys import argv
from typing import Optional
from telegram import __version__ as peler
from platform import python_version as memek
from IronRobot import (
    ALLOW_EXCL,
    CERT_PATH,
    DONATION_LINK,
    BOT_USERNAME as bu,
...
from IronRobot.modules import ALL_MODULES
from IronRobot.modules.helper_funcs.chat_status import is_user_admin
from IronRobot.modules.helper_funcs.misc import paginate_modules
...
PM_START_TEXT = """
*ʜᴏɪ, {} !*
┏━━✦❘°⌜[ɪʀᴏɴᴍᴀɴ](https://t.me/IronMan3RoBot) `3.0`⌟°❘✦━━┓

⌖ `ɪᴛ's ᴍᴇ ɪʀᴏɴᴍᴀɴ, ᴀ ᴠᴇʀʏ ᴘᴏᴡᴇʀғᴜʟʟ ᴀɴᴅ sᴇᴄᴜʀᴇ ʀᴏʙᴏᴛ.`
⌖ `ᴡʜɪᴄʜ ᴄᴀɴ ʜᴇʟᴘ ʏᴏᴜ ᴛᴏ ᴄᴏɴᴛʀᴏʟ ʏᴏᴜʀ ɢʀᴏᴜᴘ sᴀғᴇʟʏ.`
⌖ `ʜɪᴛ ᴏɴ` /help `ᴛᴏ ᴇxᴘʟᴏʀᴇʀ ᴀʟʟ ᴍᴏᴅᴜʟᴇs.`

「sʟᴇᴇᴘɪɴɢ ᴜᴘᴛɪᴍᴇ: `{}`」

✘ ╡ᴜsᴇʀs: `{}` ||ᴄʜᴀᴛs: `{}`╞

┗━✦❘°⌜[ᴛᴇᴀᴍ-sɪʟᴇɴᴛ🧚‍♀️](https://t.me/SILENT_DEVS)⌟°❘✦━┛
"""
...
buttons = [
    ...
    [
        InlineKeyboardButton(text=f"ᴀʙᴏᴜᴛ ᴍᴇ", callback_data="emiko_"),
        InlineKeyboardButton(
            text="ᴛʀʏ ɪɴʟɪɴᴇ​​", switch_inline_query_current_chat=""
        ),
    ],
    [
        InlineKeyboardButton(text="ʜᴇʟᴘ ᴀɴᴅ ᴍᴏᴅᴜʟᴇs", callback_data="help_back"),
    ],
]
...
for module_name in ALL_MODULES:
    imported_module = importlib.import_module("IronRobot.modules." + module_name)
        ...
        query.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                 ...
                 [
                    InlineKeyboardButton(text="Source Code", url="https://github.com/kennedy-ex/IronRobot"),
                 ],
                 [
...
def get_help(update: Update, context: CallbackContext):
    ...
    if chat.type != chat.PRIVATE:
        if len(args) >= 2 and any(args[1].lower() == x for x in HELPABLE):
            ...
            return
        update.effective_message.reply_text(
            "ʜᴇʀᴇ ɪs ᴛʜᴇ ɪʀᴏɴᴍᴀɴ ʜᴇʟᴘ ᴍᴇɴᴜ ɢᴏ ᴛᴏ ʙᴏᴛ's ᴘᴍ ᴏʀ ᴇxᴘʟᴏʀᴇʀ ʜᴇʀᴇ🧚‍♀️.",
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton(
                    ...
                    [
                        InlineKeyboardButton(text="⇩ᴇxᴘʟᴏʀᴇʀ ᴄᴍᴅs ʜᴇʀᴇ⇩", callback_data="help_back"),
                    ],
                ]
            ),
        )
