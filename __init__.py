...
def get_user_list(__init__, key):
    with open("{}/IronRobot/{}".format(os.getcwd(), __init__), "r") as json_file:
        return json.load(json_file)[key]

# enable logging
FORMAT = "[IronRobot] %(message)s"
logging.basicConfig(
...
LOGGER = logging.getLogger('[IronRobot]')
...
if ENV:
    ...
    from IronRobot.config import Development as Config
...
from IronRobot.modules.sql import SESSION
...
from IronRobot.modules.helper_funcs.handlers import (
